    ...
    return (
        <footer>
            <div className="px-12 pt-0 pb-32 text-center lg:py-4">
                <SectionTitle>Dipu Singh</SectionTitle>
                ...
                <ul className="flex justify-center gap-5">
                    <li>
                        <SocialLink href="https://github.com/Rkssh">
                            <BsGithub className={socialLinkClass} />
                        </SocialLink>
                    </li>
                    <li>
                        <SocialLink href="https://www.linkedin.com/in/erdipusingh/">
                            <BsLinkedin className={socialLinkClass} />
                        </SocialLink>
                    </li>
                    <li>
                        <SocialLink href="https://twitter.com/Rkssh7">
                            <BsTwitter className={socialLinkClass} />
                        </SocialLink>
                    </li>
                </ul>
                <span className="block mt-16 text-text-light text-xs lg:text-[.813rem]">
                    &#169; Copyright Dipu-Singh. All rights reserved. <br />
